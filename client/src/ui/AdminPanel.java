...
class DynamicTree extends JPanel {
                    	...
                    	public void actionPerformed(ActionEvent actionEvent) {
                    	    ...
                    	    if(currentNode != null){ 	    
                    	       ...
                    	       if (nodeInfo instanceof Department){
                    	    	   ...
                    	    	   userForm.addPropertyChangeListener(new PropertyChangeListener() {
                    	    		    @Override
                    	    		    public void propertyChange(PropertyChangeEvent result) {
                    	    	   ...
                    	    	   departmentForm.addPropertyChangeListener(new PropertyChangeListener() {
                    	    		    @Override
                    	    		    public void propertyChange(PropertyChangeEvent result) {
                    	    ...
                    	    if(currentNode != null){ 	    
                    	       ...
                    	       if (nodeInfo instanceof Department){
                    	    	   ...
                    	    	   departmentForm.addPropertyChangeListener(new PropertyChangeListener() {
                    	    		    ...
                    	    		    public void propertyChange(PropertyChangeEvent result) {
                    	    		        Department department = (Department) result.getNewValue();
                    	    		        treePanel.updateObject(department);
                    	    		    }
                    	    		});                    		       
                    	       }	        
                    	  }
  ...
  public void updateObject(Object child) {
	    DefaultMutableTreeNode parentNode, parentNodeRem = null;
	    TreePath parentPath = tree.getSelectionPath();
